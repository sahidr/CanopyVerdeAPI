...
from .views import CreateViewGreenPoint, DetailsViewGreenPoint, CreateViewBadge, DetailsViewBadge, CreateViewStats,DetailsViewStats, CreateViewUserProfile, DetailsViewUserProfile, CreateViewUser, DetailsViewUser
...
urlpatterns = {
    ...
    url(r'^userProfile/$', CreateViewUserProfile.as_view(), name="createUserProfile"),
    url(r'^userProfile/(?P<pk>[0-9]+)/$', DetailsViewUserProfile.as_view(), name="detailsUserProfile"),
